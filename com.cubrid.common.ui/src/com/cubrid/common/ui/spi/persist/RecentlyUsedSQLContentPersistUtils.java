...
public class RecentlyUsedSQLContentPersistUtils {
    ...
    private static HashMap<String, LinkedList<String>> recentlyUsedSQLContent =
            new HashMap<String, LinkedList<String>>();
    private static final Logger LOGGER =
            LogUtil.getLogger(RecentlyUsedSQLContentPersistUtils.class);
    private static final int MAXSQLCOUNT = 30;
    public static final String[] SUPPORTSQL = {
        "select", "select * from", "update", "insert into", "delete from", "with"
    };
     ...
     */
    public static void saveRecentlyUsedSQLContentsById(
            String id, LinkedList<String> recentlyUsedSQLContentList) {
        ...
        PersistUtils.setPreferenceValue(
                RecentSQLContentAssistProcessor.ID, id, savedString.toString());
    }
    /**
