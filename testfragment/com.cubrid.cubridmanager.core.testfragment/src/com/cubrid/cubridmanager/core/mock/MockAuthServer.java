 ...
 *
 * <p>a mockup authentication server for a JUnit test framework
 *
 * @author pcraft
...
public class MockAuthServer extends Thread implements IMockServer {
    ...
    public static final String VALID_TOKEN =
            "4504b930fc1be99b53150f8614c1b813904e8f36e4f8cd68db53a53dd5ccd9aa7926f07dd201b6aa";

    private static Map<String, MockAuthServer> authSessionMap =
            new HashMap<String, MockAuthServer>();
