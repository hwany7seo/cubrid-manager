...
public class DbBackupInfoTest extends TestCase {
    ...
    public void testDbBackupInfo() {
        ...
        list.add(new DbBackupHistoryInfo("1", "/home/daniel", "100", "2009/10/12"));
        dbBackupInfo.setBackupHistoryList(list);
        dbBackupInfo.addDbBackupHistoryInfo(
                new DbBackupHistoryInfo("1", "/home/daniel", "100", "2009/10/12"));
        dbBackupInfo.addDbBackupHistoryInfo(
                new DbBackupHistoryInfo("1", "/home/daniel", "100", "2009/10/12"));
        dbBackupInfo.addDbBackupHistoryInfo(
                new DbBackupHistoryInfo("2", "/home/daniel2", "200", "2009/10/22"));
        assertEquals(dbBackupInfo.getDbDir(), "/home/daniel");
        assertEquals(dbBackupInfo.getFreeSpace(), "100");
        assertTrue(dbBackupInfo.getBackupHistoryList().size() == 4);
        dbBackupInfo.addDbBackupHistoryInfo(null);
        dbBackupInfo.addDbBackupHistoryInfo(null);
    }
}
