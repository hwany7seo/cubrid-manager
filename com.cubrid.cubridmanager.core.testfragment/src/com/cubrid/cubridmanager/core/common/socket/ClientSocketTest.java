...
public class ClientSocketTest extends SetupEnvTestCase {
    ...
    public void testParseResponse() throws Exception {
        String filepath =
                this.getFilePathInPlugin(
                        "/com/cubrid/cubridmanager/core/messageSendReceiveTest.txt");
    ...
    private void getautoaddvollog() {
        ...
        ClientSocket cs =
                new ClientSocket(serverInfo.getHostAddress(), jpport, serverInfo.getUserPassword());
    ...
    private void dbspaceinfoFailed() {
        ...
        ClientSocket cs =
                new ClientSocket(serverInfo.getHostAddress(), jpport, serverInfo.getUserName());
