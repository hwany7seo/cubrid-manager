...
public class TreeNodeTest extends SetupEnvTestCase {
    ...
    public void testDIAG_DEL() throws Exception {
        String filepath =
                this.getFilePathInPlugin(
                        "/com/cubrid/cubridmanager/core/receive.msg/DIAG_DEL-getdiagdata");
    ...
    public void testMultiValues() throws Exception {
        String filepath =
                this.getFilePathInPlugin("/com/cubrid/cubridmanager/core/receive.msg/class");
        String msg = Tool.getFileContent(filepath);
    ...
    public void testMultiColon() throws Exception {
        String filepath =
                this.getFilePathInPlugin(
                        "/com/cubrid/cubridmanager/core/receive.msg/analyzecaslog");
        String msg = Tool.getFileContent(filepath);
    ...
    public void testAddChild() throws Exception {
        String filepath =
                this.getFilePathInPlugin(
                        "/com/cubrid/cubridmanager/core/receive.msg/addattribute_receive");
        String msg = Tool.getFileContent(filepath);
    ...
    public void testGet() {
        ...
        assertEquals(
                "8ec1ab8a91333c78ae2c9a2b32cbafd84585fd932e7e2fac88b7d31a95a5fadf7926f07dd201b6aa",
                node.getValue("token"));
    }
